...
export const CMD_CODELENS_SHOW_CODE_ADD_CODE_SAMPLE = 'autodev.codelens.addCodeSample';
export const CMD_CODELENS_SHOW_CODE_REMOVE_CODE_SAMPLE = 'autodev.codelens.removeCodeSample';
